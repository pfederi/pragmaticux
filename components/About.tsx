    ...
    <section className="py-32">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-left mb-20">
          <h2 className="text-5xl font-bold mb-8 bg-gradient-to-r from-foreground to-primary bg-clip-text text-transparent leading-[1.2]">About The Pragmatic UX Design Approach</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div className="bg-gradient-to-br from-card to-muted/20 border rounded-xl p-8">
            <h3 className="text-2xl font-semibold mb-4 text-foreground">The Origin</h3>
          ...
          <div className="bg-gradient-to-br from-card to-muted/20 border rounded-xl p-8">
            <h3 className="text-2xl font-semibold mb-4 text-foreground">The Philosophy</h3>
            <p className="text-muted-foreground leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Patrick Federi */}
          <div className="bg-gradient-to-br from-card to-muted/20 border rounded-xl p-8 flex flex-col">
            <h3 className="text-2xl font-semibold mb-6 text-foreground">Patrick Federi</h3>
            <div className="space-y-2 mb-8 flex-grow">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 border-2 border-primary text-primary rounded-lg font-medium hover:bg-primary hover:text-primary-foreground transition-all duration-200 shadow-md hover:shadow-lg mt-auto w-fit"
              >
          ...
          {/* Ergon Informatik AG */}
          <div className="bg-gradient-to-br from-card to-muted/20 border rounded-xl p-8 flex flex-col">
            <h3 className="text-2xl font-semibold mb-6 text-foreground">Ergon Informatik AG</h3>
            <div className="space-y-2 mb-8 flex-grow">
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-muted-foreground leading-relaxed">
