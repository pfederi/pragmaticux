      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-left mb-8 sm:mb-12 md:mb-20">
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-full sm:max-w-[75%] leading-relaxed">
            Pragmatic UX Design emerged from real-world challenges in product development, where traditional UX Design processes often clashed with business realities.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 mb-8 sm:mb-12 md:mb-16">
          <div className="bg-gradient-to-br from-card to-muted/20 border rounded-xl p-4 sm:p-6 md:p-8">
            ...
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                Pragmatic UX Design was developed through hands-on experience working on diverse projects at Ergon, where I encountered teams with varying UX Design maturity, timelines, and constraints. Rather than forcing a one-size-fits-all approach, I learned to adapt UX Design methods to each unique context.
              </p>
            </div>
          <div className="bg-gradient-to-br from-card to-muted/20 border rounded-xl p-4 sm:p-6 md:p-8">
            <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-foreground">The Philosophy</h3>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                Pragmatic UX Design isn't about cutting corners, it's about being strategic. It's the result of countless projects where I discovered that the most impactful UX Design work happens when we focus on what truly matters for users and business goals, rather than following rigid processes.
              </p>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-card to-muted/20 border rounded-xl p-4 sm:p-6 md:p-8 flex flex-col">
            ...
            <div className="space-y-2 mb-6 sm:mb-8 flex-grow">
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                  <strong>Head of UX Design</strong> at Ergon Informatik AG
                </p>
              </div>
              <div className="flex items-start gap-2 sm:gap-3">
                <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                  Experienced UX Design professional with a passion for user-centred design and digital innovation
                </p>
              </div>
              <div className="flex items-start gap-2 sm:gap-3">
                <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
